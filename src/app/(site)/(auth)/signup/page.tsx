      ...
      <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden flex min-h-[580px]">
        ...
        <div className="hidden md:flex md:w-[42%] signup-panel-gradient flex-col justify-between p-10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-gray-500 text-sm mb-2">Organiza tu día</p>
            <h2 className="text-white font-bold text-2xl leading-snug">
              Gestiona tus tareas con claridad y sin esfuerzo.
            </h2>
          </div>
        ...
        <div className="flex-1 p-10 md:p-12 flex flex-col justify-center">
          ...
          <p className="text-gray-400 text-sm mb-8 leading-relaxed max-w-sm">
            Accede a tus tareas, notas y proyectos desde cualquier lugar — y mantén todo en un solo sitio.
          </p>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-4 text-sm text-gray-400">o continúa con</span>
            </div>
          </div>

          {/* Social buttons */}
          <div className="flex gap-3">
            <button className="flex-1 flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-3 hover:bg-gray-50 transition-colors">
